...
import 'package:flutter_template/webview/webview_page.dart';
import 'package:flutter_template/business/login/login_page.dart';
...
class ARouterInternalImpl extends ARouterInternal {
  ...
  dynamic instanceFromClazz(Type clazz, dynamic option) {
    switch (clazz) {
      ...
      case LoginPage:
        return new LoginPage(option);
      case UserPage:
        return new UserPage(option);
      default:
        return null;
    }
  }
